...
class Note(TimeStampedBase):
    ...
    user_id = Column(String(10), ForeignKey("tb_user.user_id"), nullable=False, comment='노트를 생성한 유저 아이디')
    ...
    contents = Column(Text, nullable=True, comment='본문')
    contents_ocr = Column(Text, nullable=True, comment='본문 LLM 결과')
